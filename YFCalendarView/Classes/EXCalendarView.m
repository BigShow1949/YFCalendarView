...
- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.monthData = _monthsData[_currentSelectedIndexPath.section];
...
- (void)scrollUpdateData {
    ...
    if ([self.delegate respondsToSelector:@selector(calendarDidEndScrolling)]) {
        [self.delegate calendarDidEndScrolling];
    }
}
